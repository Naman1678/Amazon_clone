<?php
		...
		{
			header("Location: http://localhost/Plants/login.php");
		}*/
		include 'includes/left-bar.php';
		// Include database connection settings
		include 'config/database.php';
?>
<div class="col-md-10" style="background: url('images/prof.jpg') no-repeat;background-size: 100%;min-height:670px;"">
		<br/><br/><br/><br/><br/>
		<div class="col-md-11">
		<br/>
		<?php
			...
			while($arr=mysqli_fetch_row($res))
			{
				...
				echo "<div class='col-md-6 game' style='background:#f5deb3;'>";
					echo "<table><tr><td><h3 style='color:black;'>Name : </h3></td><td><h3 style='color:black;'>$arr[2] $arr[3]</h3></td></tr>";
					echo "<tr><td><h3 style='color:black;'>Email : </h3></td><td><h3 style='color:black;'>$arr[4]</h3></td></tr>";
					echo "<tr><td><h3 style='color:black;'>Username : &nbsp;&nbsp;&nbsp;</h3></td><td><h3 style='color:black;'>$arr[1]</h3></td></tr>";
