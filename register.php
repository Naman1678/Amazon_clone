...
?>
	<div class="col-md-10" style="background: url('images/reg.jpg') no-repeat;background-size: 100%;min-height:670px;">
		<br/>
		<br/><br/><br/><br/><br/>
		<div class="container">
        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		<h3 class="panel-title" style="color:black;font-weight:bold;">New Registration </small></h3>
			 			</div>
